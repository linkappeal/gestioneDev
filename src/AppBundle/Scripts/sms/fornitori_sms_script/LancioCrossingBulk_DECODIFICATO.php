...
$Cmessaggio1 = rawurlencode($Cmessaggio);
/*
echo "--------------------------------------------------------------\n";
echo "stringa originale :     ". $Cmessaggio;
echo "\n--------------------------------------------------------------\n";

sleep(5);
echo "--------------------------------------------------------------\n";
echo "stringa in invio rawurlencode:     ". $Cmessaggio1;
echo "\n--------------------------------------------------------------\n";

$Cmessaggio2 = utf8_encode($Cmessaggio);
sleep(5);
echo "--------------------------------------------------------------\n";
echo "stringa in invio utf8_encode:     ". $Cmessaggio2;
echo "\n--------------------------------------------------------------\n";
exit;
*/
	
$send_data='username='.$username.'&password='.$password.'&ani='.$ani.'&dnis='.$recipients.'&message='.$Cmessaggio1.'&command=submit&serviceType=&longMessageMode=';
