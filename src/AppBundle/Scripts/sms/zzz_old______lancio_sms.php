                ...
                if(update_stato_campagna(4, $Cid)){
                    ...
                    if($messLenght=is_gsm0338($Cmessaggio)){
                        ...
                        if ($messLenght>160){
                            ...
                            update_stato_campagna(7, $Cid, 'errore: messaggio sopra i 160 caratteri gsm');
                            esci();
                        }
                    }else{
                        ...
                        if (strlen($Cmessaggio)>70){
                            update_stato_campagna(7, $Cid, 'errore: Messaggio non compatibile con gsm e superiore a 70 caratteri');
                            esci();
                        }
                    }
